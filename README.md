...
The project demonstrates the integration of embedded systems, sensor technology, communication protocols and software development.

## System Architecture

The Raspberry Pi acts as a central part of the system and communicates with the microcontroller, sensors and mobile application.
...
- Manual and automatic lighting control
...
A mobile application provides manual control of the lighting system. The interface allows the user to turn the light on or off and adjust the light intensity.
